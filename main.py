...
class Players(pygame.sprite.Sprite):
    def __init__(self, name, pos):
        ...
        self.walking_tick = 0
        self.attack_tick = 0
        self.walking_frames = [pygame.transform.smoothscale(pygame.image.load(image).convert_alpha(), (w*0.1257, h*0.215)) for image in
        ...
        self.reverse_walking_frames = [pygame.transform.flip((pygame.transform.smoothscale(pygame.image.load(image).convert_alpha(), (w*0.1257, h*0.215))), True, False) for image in
                               ['Assets/Stick-Man/Stick-Man Walking/Stick-Man Walking/img0.png',
                                'Assets/Stick-Man/Stick-Man Walking/Stick-Man Walking/img1.png',
                                'Assets/Stick-Man/Stick-Man Walking/Stick-Man Walking/img2.png',
                                'Assets/Stick-Man/Stick-Man Walking/Stick-Man Walking/img3.png',
                                'Assets/Stick-Man/Stick-Man Walking/Stick-Man Walking/img4.png',
                                'Assets/Stick-Man/Stick-Man Walking/Stick-Man Walking/img5.png', ]]
        self.hitting_frames = [pygame.transform.smoothscale(pygame.image.load(image).convert_alpha(), (w*0.1257, h*0.215)) for image in
        ...
        self.reverse_hitting_frames = [pygame.transform.flip((pygame.transform.smoothscale(pygame.image.load(image).convert_alpha(), (w*0.1257, h*0.215))), True, False) for image in
                               ['Assets/Stick-Man/Stick Man Wacking/Stick-Man Wacking/img0.png',
                                'Assets/Stick-Man/Stick Man Wacking/Stick-Man Wacking/img1.png',
                                'Assets/Stick-Man/Stick Man Wacking/Stick-Man Wacking/img2.png',
                                'Assets/Stick-Man/Stick Man Wacking/Stick-Man Wacking/img3.png',
        ...
        self.player_text = player_font.render(self.name, "ok", "Blue")
        self.attack_time = 0
        ...
        if self.name == "Player 2":
            ...
            self.text_health_control = {
                'player_health_level': 100,
                "player_text": self.player_text,
                "player_text_rect": self.player_text.get_rect(topleft=(self.rect.centerx, self.rect.y-100)),
                "player_health_bar_rect": pygame.Rect((self.rect.centerx, self.rect.y-70), (100,20)),
                "player_health_bar_background_rect": pygame.Rect((self.rect.centerx, self.rect.y-70), (100,20)),
                "player_health_bar_outline_rect": pygame.Rect((self.rect.centerx, self.rect.y-70), (100,20))
    ...
    def move1(self):
        ...
        if key[self.control["right"]]:
            ...
            self.move2("left")
        if key[self.control['attack']] and int(pygame.time.get_ticks()/100)>= self.attack_time+5 or self.control['attacked']== True :
    ...
    def move2(self, control):
        ...
        if control == "right":
            ...
            self.image = self.walking_frames[self.walking_frame_num]
            direction.x +=1
            self.text_health_control['player_text_rect'] = self.player_text.get_rect(topleft=(self.rect.x+20, self.rect.y - 105))
            self.text_health_control['player_health_bar_outline_rect'].update((self.rect.x, self.rect.y - 75), (100, 20))
            self.text_health_control['player_health_bar_background_rect'].update((self.rect.x, self.rect.y - 75), (100, 20))
            self.text_health_control['player_health_bar_rect'].update((self.rect.x, self.rect.y - 75), (self.text_health_control['player_health_level'], 20))
        if control == "left":
            self.walking_frame_num = self.walking_tick//3

            self.image = self.reverse_walking_frames[self.walking_frame_num]
            direction.x -=1
            self.text_health_control['player_text_rect'] = self.player_text.get_rect(topleft=(self.rect.centerx-20, self.rect.y - 105))
            self.text_health_control['player_health_bar_outline_rect'].update((self.rect.centerx, self.rect.y - 75), (100, 20))
            self.text_health_control['player_health_bar_background_rect'].update((self.rect.centerx, self.rect.y - 75), (100, 20))
            self.text_health_control['player_health_bar_rect'].update((self.rect.centerx, self.rect.y - 75), (self.text_health_control['player_health_level'], 20))
    ...
    def attack(self):
        ...
        if self.control['facing_right'] == True:
...
player1 = Players("Player 1", (w*.03, h*0.8))
player2 = Players("Player 2", (w*.97, h*0.8))
